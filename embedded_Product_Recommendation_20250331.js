    ...
    if (document.location.href.includes(link_included)) {
        ...
        function ensureEmbeddedAdJQueryLoaded(callback) {
            if (typeof jQuery === 'undefined') {
                ...
                embeddedAdjQueryScript.src = 'https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js'; // 指定需要的 jQuery 版本
        ...
        function loadSwiperScript() {
            ...
            swiperStylesheet.href = 'https://cdn.jsdelivr.net/npm/swiper/swiper-bundle.min.css';
            document.head.appendChild(swiperStylesheet);

            var SwiperScript = document.createElement('script');
            SwiperScript.src = 'https://cdn.jsdelivr.net/npm/swiper/swiper-bundle.min.js'; // 替換為 slick 的 URL
                ...
                function updatePopAd(images, corr_bool) {
                    const items = images
                        .map(
                            (img) =>
                                `
<a class="embeddedItem swiper-slide" href="${img.link
    ...
    <div class="embeddedItem__imgBox" style="background-color:#efefef;">
        <img src="${img.image_link}" alt="${img.description
    ...
    <div class="embeddedItemInfo">
        ...
        ${img.sale_price && img.sale_price !== img.price ?
            ...
            <p class="embeddedItemInfo__discount">${Math.ceil(
                                        100 - (parseInt(img.sale_price.replace(',', '')) * 100 / parseInt(img.price.replace(',', '')))
                                    )}% off</p>
