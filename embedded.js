;(function () {
  function Product_Recommendation(config = {}) {
    ...
    // 解構出常用參數
    const { brand, containerId, customEdm } = finalConfig
    ...
    function app91_sku() {
      var skuContent = document.location.href.split('?')[0].split('/SalePage/Index/')[1]
    ...
    function loadEmbeddedScript($) {
      ;(function ($) {
        ...
        customCSS.innerHTML = `:root {
                    ...
                    .embeddedAdContainer .embeddedAdImgContainer .embeddedItem .embeddedItem__img .embeddedItem__sizeTag {
                      position:absolute;
                      bottom:9.5px;
                      right:9.5px;
                      border-radius: 40px;
                    ...
                    .embeddedAdContainer:has(.swiper-grid) .swiper-prev,
                    .embeddedAdContainer:has(.swiper-grid) .swiper-next {
                      display: none;
                    }
                    .swiper-grid .swiper-slide {
                      padding-bottom: 0 !important;
                       ...
                       @media (min-width: 768px) {
                        ...
                        .swiper-grid .swiper-slide:nth-child(4),
                        .swiper-grid .swiper-slide:nth-child(5),
                        .swiper-grid .swiper-slide:nth-child(6) {
        ...
        $(function () {
          ...
          var embeddedContainer = `
                  ...
                  <div
                  class="embeddedAdImgContainer carouselContainer swiper swiper-basic-${containerId} ${window.SWIPER_GRID_AVAILABLE ? 'swiper-grid' : ''}"
...
`
          ...
          var swiper = new Swiper(`.swiper-basic-${containerId}`, {
            ...
            pagination: false,
            autoplay:
              finalConfig?.breakpoints[768].gridRows > 1 ||
